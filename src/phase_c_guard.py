...
async def check_input_rail(text: str, rails=None) -> dict:
    ...
    blocked = any(kw in content.lower() for kw in refuse_keywords)
    return {
        "allowed":        not blocked,
...
if __name__ == "__main__":
    ...
    report_data = {
        "adversarial_suite_pass_rate": passed / len(results) if results else 0,
        "adversarial_suite_results": results,
